...
function AdminNurse() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/admin/get-department");
        ...
        <div className=" w-[70%] ms-24 p-4 flex flex-col justify-start gap-5 ">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-green-500 p-2 rounded-md text-xs px-4 hover:scale-110 duration-200 active:scale-90  text-white"
            >
              Add Nurse
            </button>
          </div>
