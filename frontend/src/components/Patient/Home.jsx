...
function Home() {
  ...
  return (
    <div className="bg-[#FEFAE0] ">
      <section>
        <div className="flex flex-col lg:flex-row h-screen w-screen justify-center items-center max-w-7xl m-auto border-b-8">
          <motion.div
            ref={ref}
            initial={{ opacity: 0 }}
            ...
            className="flex flex-col justify-center space-y-[20px]"
          >
            <p className="text-3xl font-semibold text-center underline underline-offset-8">
              The Power to Heal{" "}
            </p>
            <p className="text-lg text-center">
              To Undertake Specialized And holistic healthcare services of world
              standard and to provide them to all sections
            </p>
          </motion.div>
          <motion.div
            ref={ref}
          ...
          >
            <img src={banner} alt="hero" className="h-[300px]  shadow-black" />
          </motion.div>
        </div>
      </section>
      <motion.section>
        <div className="w-full h-full flex flex-col justify-center items-center space-y-[50px]">
          <p className="font-semibold text-3xl underline-offset-8 underline">
            Why Choose Us?
          </p>
      ...
      <motion.section
        ...
        whileInView={{ opacity: 1 }}
      >
        <div className="h-full max-w-7xl flex flex-col m-auto justify-center items-center overflow-auto space-y-[50px]">
          <p className="font-semibold text-3xl pt-16 underline underline-offset-8">
            Meet Our Specialist
          </p>
